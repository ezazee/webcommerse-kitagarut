<?= $this->extend('layout/template_single_produk'); ?>
        ...
        <div class="ps-page__container">
                ...
                <div class="ps-product--detail ps-product--fullwidth">
                    <div class="ps-product__header">
                        ...
                        <div class="ps-product__info">
                            ...
                            echo form_hidden('harga_produk', $produkdetail['harga_produk']);
                            echo form_hidden('nama_merchant', $produkdetail['nama_toko']);
                            echo form_hidden('id_merchant', $produkdetail['id_merchant']);
                            echo form_hidden('berat_produk', $produkdetail['berat_produk']);
                            echo form_hidden('slug', $produkdetail['slug']);
                            ?>
                            ...
                            <div class="ps-product__sharing">
                                ...
                                <a class="twitter" href="#"><i class="fa fa-ambulance"></i></a>
            ...
            <div class="ps-page__right">
                ...
                <aside class="widget widget_sell-on-site">
                    <p><i class="icon-store"></i> Mau Jualan di KitaGarut?<a href="#"> Daftar Sekarang !</a></p>
                </aside>
                ...
                <div class="ps-carousel--nav owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="10000" data-owl-gap="30" data-owl-nav="true" data-owl-dots="true" data-owl-item="6" data-owl-item-xs="2" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="4" data-owl-item-xl="5" data-owl-duration="1000" data-owl-mousedrag="on">
                    <?php foreach ($produk_samping as $row) : ?>
                        <div class="ps-product">
                            ...
                            <div class="ps-product__container"><a class="ps-product__vendor" href="/produk/detail-produk/<?= $row['slug']; ?>">KitaGarut</a>
                                <div class="ps-product__content"><a class="ps-product__title" href="/produk/detail-produk/<?= $row['slug']; ?>"><?= $row['nama_produk']; ?></a>
                                    <div class="ps-product__rating">
                                        <br>
                                    </div>
