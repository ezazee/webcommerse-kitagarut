                        ...
                        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                            <form action="/frontend/new_home/konfirmasi_pesanan" method="post">
                                ...
                                <?php if ($user['kota'] == 126) : ?>
                                    <div class="alert alert-info" role="alert">
                                        <p>Lokasi Anda mendukung pengiriman sameday dengan kurir Carlos, klik tombol dibawah untuk melakukan pengiriman di hari yang sama </p>
                                    </div>
                                    <a href="/frontend/my_profile" class="ps-btn ps-btn--fullwidth" style="background-color: green;">Kirim Hari ini</a>
                                    <br> <br>
                                <?php endif; ?>
