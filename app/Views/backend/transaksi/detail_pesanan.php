    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title"><a href="/backend/transaksi" class="btn waves-effect waves-light btn-info"><i class="fas fa-arrow-circle-left"></i> Kembali</a> &nbsp;<br></h4>

                        <div class="row col-md-12 col-xs-12 d-flex justify-content-between">
                            <h4 class="card-title">Detail <?= $judul . ' | No. Transaksi ' . $no_trans; ?></h4>
