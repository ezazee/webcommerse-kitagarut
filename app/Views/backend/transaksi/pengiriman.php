                                    ...
                                    <?php foreach ($pengiriman as $row) : ?>
                                        <tr>
                                            ...
                                            <?php elseif ($row['status_trans'] == 2) : ?>
                                                <td class="text-center"><span class="badge badge-success">Pesanan Sedang diproses</span></td>
                                            <?php elseif ($row['status_trans'] == 6) : ?>
                                                <td class="text-center"><span class="badge badge-danger">Pembayaran ditolak</span></td>
                                            <?php endif; ?>

                                            <td class="text-center">
                                                <a href="/backend/transaksi/kirim_carlos/<?= $row['no_trans']; ?>" class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Kirim Notif ke kurir"><i class="fab fa-telegram-plane"></i> Notif</a>
                                                <a href="/backend/transaksi/pesanan_selesai/<?= $row['no_trans']; ?>" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Pesanan Selesai">Selesai</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
