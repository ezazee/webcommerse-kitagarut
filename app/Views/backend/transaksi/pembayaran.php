                            ...
                            <table id="tabelku" class="table display table-bordered table-striped info-bordered-table">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center font-weight-bolder">Tanggal Pemesanan</th>
                                        <th class="text-center font-weight-bolder">No Transaksi</th>
                                        <th class="text-center font-weight-bolder">Total Pembayaran</th>
                                        <th class="text-center font-weight-bolder">Nominal Transfer</th>
                                        <th class="text-center font-weight-bolder">Bukti Transfer</th>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($pembayaran as $row) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?= rupiah($row['nominal_transfer']); ?></td>
                                            <td class="text-center align-middle">
                                                <img src="<?= base_url('/assets/upload/bukti_transfer/' . $row['bukti_trans']) ?>" alt="user" class="img-circle" width="50px" /><br>
                                                <a class="text-center" href="<?= base_url('/assets/upload/bukti_transfer/' . $row['bukti_trans']) ?>" target="_blank"> Lihat</a>
                                            </td>
                                            <td class="text-center">
                                                <a href="/backend/transaksi/terima_pembayaran/<?= $row['no_trans']; ?>" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Terima Pembayaran">Terima</a>
                                                <a href="/backend/transaksi/tolak_pembayaran/<?= $row['no_trans']; ?>" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Tolak Pembayaran">Tolak</a>
