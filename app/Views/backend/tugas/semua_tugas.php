                            ...
                            <table id="tabelku" class="table table-bordered table-striped color-bordered-table info-bordered-table" cellspacing="0" width="100%">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center align-middle">Tugas Untuk</th>
                                ...
                                <tbody>
                                    <?php $no = 1; ?>
                                    <?php foreach ($semua_tugas as $row) : ?>
                                        <tr>
                                            <td><?= $no++; ?></td>
                                            ...
                                            <td class="text-center align-middle">
                                                <div class="btn-group mr-2" role="group" aria-label="First group">
                                                    ...
                                                    if (in_array($row['status_tugas'], $array)) : ?>
                                                        <a href="/tugas/lihat_tugas/<?= $row['id_tugas']; ?>" target="_blank" type="button" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="" data-original-title="Lihat detail tugas"><i class="fas fa-file-alt"></i></a>
                                                    <?php endif; ?>
