            ...
            <div class="col-md-4 col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label class="text-center">Tanggal Tugas </label>
                            <h5 class="font-weight-bold text-info"><?= longdate_indo($detail_tugas['tgl_tugas']); ?></h5>
                        </div>
                        <div class="form-group">
                            <label class="text-center">Deadline Tugas </label>
                            <h5 class="font-weight-bold text-info"><?= longdate_indo($detail_tugas['tgl_deadline']); ?></h5>
                        </div>
                        <div class="form-group">
                        ...
                        <?php if ($detail_tugas_kinerja != null) : ?>
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label class="text-center">Tanggal pembuatan Laporan</label>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    <label class="text-center">Jam terima tugas </label>
                                    <h5 class="font-weight-bold text-info"><?= $detail_tugas_kinerja['jam_mulai']; ?></h5>
                                </div>
                                <div class="form-group col-md-4">
                                    <label class="text-center">Jam pembuatan Laporan</label>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label class="text-center">Tanggapan Tugas </label>
                                    ...
                                    <h5 class="font-weight-bold text-info text-align-middle">
                                        <?php if ($detail_tugas_kinerja['status_tugas'] == 0) : ?>
                                            ...
                                            <span class="badge badge-pill badge-danger text-white ml-auto ">
                                                <h4 class="align-middle"> Belum dikerjakan</h4>
                                            </span>
                                        <?php elseif ($detail_tugas_kinerja['status_tugas'] == 1) : ?>

                                            <span class="badge badge-pill badge-primary text-white ml-auto ">
                                                <h4 class="align-middle"> sedang dikerjakan</h4>
                                            </span>
                                        <?php elseif ($detail_tugas_kinerja['status_tugas'] == 2) : ?>
                                            <label class="badge badge-pill badge-info d-inline-flex align-items-center justify-content-start">
                                                <span class="text-white ml-auto align-middle">
                                                    <h4 class="align-middle"> menunggu verifikasi</h4>
                                                </span>
                                            </label>
                                        <?php elseif ($detail_tugas_kinerja['status_tugas'] == 3) : ?>

                                            <span class="badge badge-pill badge-success text-white ml-auto ">
                                                <h4 class="align-middle"> Ok</h4>
                                            </span>
