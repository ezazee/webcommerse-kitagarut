                    ...
                    <div class="card-body">
                        <div class="row col-md-12 col-xs-12 d-flex justify-content-between">
                            ...
                            <div class="d-flex justify-content-end">
                                <a href="<?= base_url('/backend/master/tambahProduk'); ?>" class="btn waves-effect waves-light btn-info"><i class="fa fa-plus-circle"></i> Tambah Data</a>
                            </div>
                        </div>
                        <hr>
                        <div class="m-t-40">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">
                                                <div class="btn-group mr-2" role="group" aria-label="First group">
                                                    <a href="/backend/master/get_edit/<?= $row['id_produk']; ?>" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="" data-original-title="Update Data">
                                                    ...
                                                    <a href="/backend/master/detailProduk/<?= $row['id_produk']; ?>" class="btn btn-info" data-toggle="tooltip" data-id="<?= $row['id_produk']; ?>" data-placement="top" title="" data-original-title="Lihat Detail"><i class="fas fa-search"></i></a>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?= form_open('/backend/master/deleteprod'); ?>
