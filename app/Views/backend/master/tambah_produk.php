                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="home" role="tabpanel">
                                <div class="card-body">
                                    <?= form_open_multipart(base_url('/backend/master/tambahProd'), 'class="mt-4"'); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6 col-sm-12">
                                            ...
                                            <div class="col-md-12">
                                                <input type="number" placeholder="Harga Seller" class="form-control form-control-line <?= ($validation->hasError('harga_produk')) ? 'is-invalid' : ''; ?>" name="harga_produk" autocomplete="off" value="<?= old('harga_produk'); ?>" />
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="form-group col-md-6 col-sm-12">
                                            ...
                                            <div class="col-md-12">
                                                <input type="number" placeholder="Harga Jual" class="form-control form-control-line <?= ($validation->hasError('harga_seller')) ? 'is-invalid' : ''; ?>" name="harga_seller" autocomplete="off" value="<?= old('harga_seller'); ?>" />
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="form-group col-md-6 col-sm-12">
                                            ...
                                            <div class="input-group col-md-12">
                                                <input type="number" class="form-control form-control-line " name="expired" id="expired" placeholder="Hari" autocomplete="off">
