                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="home" role="tabpanel">
                                <div class="card-body">
                                    <?= form_open(base_url('/backend/mitrakg/tambahMerchant'), 'class="mt-4"'); ?>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6 col-sm-12">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" placeholder="No. KTP" class="form-control form-control-line <?= ($validation->hasError('no_ktp')) ? 'is-invalid' : ''; ?>" name="no_ktp" id="no_ktp" autocomplete="off" required value="<?= old('no_ktp'); ?>" />
                                        ...
                                        <div class="form-group col-md-6 col-sm-12">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" placeholder="Nama Seller" class="form-control form-control-line <?= ($validation->hasError('nama_seller')) ? 'is-invalid' : ''; ?>" name="nama_seller" id="nama_seller" autocomplete="off" required value="<?= old('nama_seller'); ?>" />
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="form-group col-md-6 col-sm-12">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" placeholder="Nama Toko" class="form-control form-control-line <?= ($validation->hasError('nama_toko')) ? 'is-invalid' : ''; ?>" name="nama_toko" autocomplete="off" value="<?= old('nama_toko'); ?>" />
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="form-group col-md-6 col-sm-12">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" placeholder="Koordinat" class="form-control form-control-line <?= ($validation->hasError('koordinat_merchant')) ? 'is-invalid' : ''; ?>" name="koordinat_merchant" autocomplete="off" value="<?= old('koordinat_merchant'); ?>" />
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="form-group col-md-6 col-sm-12">
                                            ...
                                            <div class="col-md-12">
                                                <input type="number" placeholder="Kontak Merchant" class="form-control form-control-line <?= ($validation->hasError('no_hp_merchant')) ? 'is-invalid' : ''; ?>" name="no_hp_merchant" autocomplete="off" value="<?= old('no_hp_merchant'); ?>" />
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="form-group col-md-6 col-sm-12">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control col-md-12 mydatepicker" data-date-format='dd/mm/yyyy' name="tgl_join" id="tgl_join" placeholder="dd/mm/yyyy" autocomplete="off" required>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4 col-sm-12">
                                            ...
                                            <div class="col-md-12">
                                                <select class="dept form-control custom-select kategori <?= ($validation->hasError('provinsi')) ? 'is-invalid' : ''; ?>" id="provinsi" name="provinsi" value="<?= old('provinsi'); ?>" style="width: 100%; height:36px;">
                                                    <option value=""></option>
                                        ...
                                        <div class="form-group col-md-4 col-sm-12">
                                            ...
                                            <div class="col-md-12">
                                                <select class="dept form-control custom-select kategori <?= ($validation->hasError('kota')) ? 'is-invalid' : ''; ?>" id="kota" name="kota" value="<?= old('kota'); ?>" style="width: 100%; height:36px;">
                                                    <option value=""></option>
                                        ...
                                        <div class="form-group col-md-4 col-sm-12">
                                            ...
                                            <div class="col-md-12">
                                                <select class="dept form-control custom-select kategori <?= ($validation->hasError('kecamatan')) ? 'is-invalid' : ''; ?>" id="kecamatan" name="kecamatan" value="<?= old('kecamatan'); ?>" style="width: 100%; height:36px;">
                                                    <option value=""></option>
                                                </select>
                                            </div>
                                        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#kota').change(function() {
            ...
            $.ajax({
                url: "<?php echo site_url('backend/mitrakg/get_kecamatan'); ?>",
                method: "POST",
                data: {
                    id: id
                },
