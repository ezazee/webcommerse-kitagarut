                    ...
                    <div class="card-body">
                        <div class="row col-md-12 col-xs-12 d-flex justify-content-between">
                            ...
                            <div class="d-flex justify-content-end">
                                <a href="<?= base_url('/backend/mitrakg/view_tambah_produk'); ?>" class="btn waves-effect waves-light btn-info"><i class="fa fa-plus-circle"></i> Tambah Data</a>
                            </div>
                        </div>
                        <hr>
                        <div class="m-t-40">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">
                                                <div class="btn-group mr-2" role="group" aria-label="First group">
                                                    <a href="/backend/mitrakg/updatemerchant/<?= $row['id_merchant']; ?>" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="" data-original-title="Update Data">
...
<div class="modal" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel1">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?= form_open('/backend/mitrakg/deleteMerchant'); ?>
