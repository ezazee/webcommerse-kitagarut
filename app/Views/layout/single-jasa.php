...
<head>
    ...
    <meta property="og:url" content="https://www.kitagarut.com/jasa/detail-jasa/<?= $slug; ?>" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Rental Mobil Murah <?= $namajasa; ?> wilayah Garut" />
    <meta property="og:description" content="Mobil <?= $namajasa; ?> | KitaGarut" />
    <meta property="og:image" content="<?= base_url('/assets/images/jasa/' . $jasadetail['foto_jasa']) ?>" />

    <title>Rental Mobil Murah Lepas Kunci atau Dengan Sopir - KitaGarut</title>
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta content="Rental Mobil Murah Lepas Kunci atau Dengan Sopir - KitaGarut" property="og:title" />
    <meta content="Mobil <?= $namajasa; ?> | KitaGarut" name="description" />
        ...
        <nav class="navigation">
            <div class="container">
                <ul class="menu menu--electronic">
                    ...
                    <li><a href="/frontend/new_home/all_produk"><i class="icon-bag"></i> MULAI BELANJA</a>
                    </li>
                    <li><a href="/frontend/jasa/all_jasa"><i class="icon-briefcase"></i> CARI JASA</a>
                    </li>
