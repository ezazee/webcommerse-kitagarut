...
<head>
    ...
    <!-- fb & Whatsapp -->
    <meta property="og:url" content="https://kitagarut.com/produk/detail-produk/<?= $produkdetail['slug']; ?>" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Ayo beli <?= $produkdetail['nama_produk']; ?> hanya di Kitagarut.com" />
    <meta property="og:description" content="<?= rupiah($produkdetail['harga_seller']); ?> | KitaGarut" />
    <meta property="og:image" itemprop="image" content="<?= base_url('/assets/images/produk/' . $produkdetail['foto_1']) ?>" />
    ...
    <title> <?= $produkdetail['nama_produk']; ?> | KitaGarut</title>
