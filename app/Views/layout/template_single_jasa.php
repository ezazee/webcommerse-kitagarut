...
<head>
    ...
    <meta property="og:description" content="<?= $namajasa; ?> | KitaGarut" />
    ...
    <meta content="Rental Mobil Murah wilayah Garut" property="og:title" />
    ...
    <link defer rel="stylesheet" href="/new/plugins/fontawesome5\svg-with-js\css\fa-svg-with-js.css">
        ...
        <nav class="navigation">
            <div class="container">
                <ul class="menu menu--electronic">
                    ...
                    <li><a href="/jasa-kita"><i class="icon-briefcase"></i> CARI JASA</a>
                    </li>
